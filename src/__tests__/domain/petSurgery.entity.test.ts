// src/__tests__/domain/petSurgery.entity.test.ts
...
describe('PetSurgery Entity', () => {
  const validProps = {
    ...
    surgeryDate: new Date('2025-12-15T10:00:00Z'),
    durationMinutes: 90,
  ...
  describe('reconstitute', () => {
    it('debe reconstituir una cirugía existente con todos los campos', () => {
      const existingProps = {
        ...
        nextCheckupDate: new Date('2025-12-30T00:00:00Z'),
      };
  ...
  describe('getters', () => {
    ...
    it('debe retornar null para campos opcionales no definidos', () => {
      expect(surgery.anesthesiaUsed).toBeUndefined();
      expect(surgery.complications).toBeUndefined();
      expect(surgery.outcome).toBeUndefined();
    });
