...
import { UpdateSurgeryUseCase } from '@/application/use-cases/update-surgery.use-case';
import { DeleteSurgeryUseCase } from '@/application/use-cases/delete-surgery.use-case';
